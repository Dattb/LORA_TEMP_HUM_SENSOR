...
sht30_i2c_receive_data_tdef sht30_read_i2c_data(){
	 ...
	 unsigned char I2C_Tx_data_buff[2] = {0x2C,0x0D};
	  ...
	  HAL_I2C_Master_Transmit(&hi2c3, SHT30_I2C_ADDR, (unsigned char *)I2C_Tx_data_buff, 2, 100);
	  ...
	  HAL_I2C_Master_Receive(&hi2c3, SHT30_I2C_ADDR, (unsigned char *)I2C_Rx_data_buff, 7, 100);
